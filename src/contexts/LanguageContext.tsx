...
const translations = {
  en: {
    ...
    showAvailableTickets: "Show Available Tickets",
    myTickets: "My Tickets",
    noTicketsYet: "No tickets booked yet",
    active: "Active",
    completed: "Completed",
    cancelled: "Cancelled",
    pending: "Pending",
    ...
    minutes: "minutes",
    noRoutesFound: "No routes found for your search",
    searchAgain: "Search Again",
    backToRoutes: "Back to Routes",
    seatsAvailable: "seats available",
    bookNow: "Book Now",
    fullyBooked: "Fully Booked",
    noSchedulesFound: "No schedules available",
    myCurrentBookings: "My Current Bookings",
    bookedOn: "Booked on",
    pleaseLogin: "Please login to book tickets",
  ...
  ar: {
    ...
    origin: "المنطلق",
    destination: "الوجهة",
    chooseTransport: "اختر وسيلة النقل",
    showAvailableTickets: "عرض التذاكر المتاحة",
    myTickets: "تذاكري",
    noTicketsYet: "لم يتم حجز أي تذاكر بعد",
    active: "نشط",
    completed: "مكتمل",
    cancelled: "ملغي",
    ...
    paid: "مدفوع",
    refunded: "مسترد",
    availableRoutes: "الطرق المتاحة",
    selectSchedule: "اختر الجدولة",
    minutes: "دقائق",
    noRoutesFound: "لم يتم العثور على طرق لبحثك",
    searchAgain: "البحث مرة أخرى",
    backToRoutes: "العودة إلى الطرق",
    seatsAvailable: "مقاعد متاحة",
    bookNow: "احجز الآن",
    fullyBooked: "محجوز بالكامل",
    noSchedulesFound: "لا توجد جداول متاحة",
    myCurrentBookings: "حجوزاتي الحالية",
    bookedOn: "تم الحجز في",
    pleaseLogin: "يرجى تسجيل الدخول لحجز التذاكر",
  ...
  fr: {
    ...
    showAvailableTickets: "Afficher les Billets Disponibles",
    myTickets: "Mes Billets",
    noTicketsYet: "Aucun billet réservé pour le moment",
    active: "Actif",
    completed: "Terminé",
    cancelled: "Annulé",
    pending: "En attente",
    ...
    minutes: "minutes",
    noRoutesFound: "Aucun itinéraire trouvé pour votre recherche",
    searchAgain: "Rechercher à Nouveau",
    backToRoutes: "Retour aux Itinéraires",
    seatsAvailable: "places disponibles",
    bookNow: "Réserver Maintenant",
    fullyBooked: "Complet",
    noSchedulesFound: "Aucun horaire disponible",
    myCurrentBookings: "Mes Réservations Actuelles",
    bookedOn: "Réservé le",
    pleaseLogin: "Veuillez vous connecter pour réserver des billets",
    ticketBookedSuccessfully: "Billet réservé avec succès!",
